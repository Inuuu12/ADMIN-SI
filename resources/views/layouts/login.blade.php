          ...
          <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
              <div class="inline-flex items-center justify-center w-16 h-16 bg-emerald-100 rounded-full mb-4">
                <i x-show="isLogin" class="fas fa-sign-in-alt text-emerald-500 fa-lg"></i>
                <i x-show="!isLogin" class="fas fa-user-plus text-emerald-500 fa-lg"></i>
              </div>
              <h2 class="text-2xl font-bold text-gray-800">
                <span x-text="isLogin ? 'Yayasan Nurul Iman!' : 'Create Account'"></span>
              </h2>
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <button
    type="submit"
    class="w-full bg-emerald-500 text-white py-3 rounded-lg font-semibold hover:bg-emerald-600 focus:ring-4 focus:ring-green-600 focus:ring-opacity-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
    :disabled="
        loading ||
...
>
    ...
    <span x-show="!loading" x-text="isLogin ? 'Sign In' : 'Create Account'"></span>
              ...
              <p class="mt-6 text-center text-gray-600">
                ...
                <button
                  type="button"
                  class="ml-1 text-emerald-500 hover:text-emerald-700 font-semibold focus:outline-none"
      ...
      <div
        ...
        style="background-image: url('{{ asset('img/kegiatan/al-quran.jpg') }}')"
      >
        <div class="h-full bg-black bg-opacity-50 flex items-center justify-center">
          <div class="text-center text-white px-12">
            <h2 class="text-4xl font-bold mb-6">PPDB YAYASAN NURUL IMAN</h2>
            <p class="text-xl">SELAMAT DATANG CALON SISWA BARU</p>
          </div>
        </div>
      </div>
    </div>
