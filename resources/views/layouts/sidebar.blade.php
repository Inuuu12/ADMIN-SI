...
<div class="flex flex-col h-screen text-white px-4 overflow-y-auto" x-data="{ activeMenu: 'dashboard' }">
    ...
    <!-- Dashboard Menu -->
    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group {{ request()->is('dashboard*') ? 'bg-green-600 text-white': 'text-white' }}">
    ...
    <!-- Akademik Menu -->
    <a href="{{ route('akademik') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group {{ request()->is('akademik*') ? 'bg-green-600 text-white': 'text-white' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Foto Kegiatan Menu -->
    <a href="{{ route('fotokegiatan') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group {{ request()->is('fotokegiatan*') ? 'bg-green-600 text-white': 'text-white' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Panduan Menu -->
    <a href="{{ route('panduan') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group {{ request()->is('panduan*') ? 'bg-green-600 text-white': 'text-white' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
