...
<div class="flex flex-col h-screen text-white px-4 overflow-y-auto">
    <!-- Sidebar Content -->
    ...
    <!-- Dashboard Menu -->
        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group" :class="{'bg-green-600': request()->routeIs('dashboard')}">
    ...
    <!-- SPP Menu -->
    {{-- <a href="{{ route('spp') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group" :class="{'bg-green-600': request()->routeIs('spp')}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Foto Kegiatan Menu -->
    <a href="{{ route('fotokegiatan') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group" :class="{'bg-green-600': request()->routeIs('fotokegiatan')}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Panduan Menu -->
    <a href="{{ route('panduan') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group" :class="{'bg-green-600': request()->routeIs('panduan')}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11a4 4 0 1 0 0-8 4 4 0 1 0 0 8zm-6 10v-2a6 6 0 0 1 12 0v2"/>
        </svg>
        <span>Panduan</span>
    </a>

    <!-- Aduan Menu -->
    {{-- <a href="{{ route('aduan') }}" class="flex items-center px-4 py-2 hover:bg-white/10 rounded-lg group" :class="{'bg-green-600': request()->routeIs('aduan')}">
    ...
    <div class="xl mb-8">
    <button @click="open = true" class="transition-colors duration-200 hover:text-red-700  flex items-center gap-2 text-left px-4 py-2 hover:bg-white/10 rounded-lg transition  ">
            <!-- Icon Logout -->
