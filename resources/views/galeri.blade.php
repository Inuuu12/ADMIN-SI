            ...
            <div class="container mx-auto ">
                ...
                <div class="flex flex-wrap justify-center gap-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div
                            class="border border-gray-300 shadow-md rounded-lg overflow-hidden w-80 min-h-[360px] flex flex-col">
                            <img src="images/photo1.png" alt="Gambar 4" class="w-full h-2/3 object-cover">
                            <div class="p-4 flex flex-col flex-1">
                        ...
                        <div
                            class="border border-gray-300 shadow-md rounded-lg overflow-hidden w-80 min-h-[360px] flex flex-col">
                            <img src="images/photo1.png" alt="Gambar 5" class="w-full h-2/3 object-cover">
                            <div class="p-4 flex flex-col flex-1">
                        ...
                        <div
                            class="border border-gray-300 shadow-md rounded-lg overflow-hidden w-80 min-h-[360px] flex flex-col">
                            <img src="images/photo1.png" alt="Gambar 6" class="w-full h-2/3 object-cover">
                            <div class="p-4 flex flex-col flex-1">
