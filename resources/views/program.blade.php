...
<body>
    ...
    <div class="container mx-auto py-10">
        <h1 class="text-2xl font-bold text-center mb-4 text-gray-800">Program</h1>
                ...
                <div class="flex flex-wrap justify-center gap-8">
                    ...
                    <div
                        ...
                        <div class="w-40 h-40 m-6">
                            <img class="w-full h-full object-cover rounded-full" src="images/photo1.png"
                                alt="Foto Agus Buono">
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="w-40 h-40 m-6">
                            <img class="w-full h-full object-cover rounded-xl aspect-[4/3]" src="images/photo1.png"
                                alt="Foto Agus Buono">
                        </div>
                    </div>
