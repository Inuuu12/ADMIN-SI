    ...
    <div class="relative">
        ...
        <div class="relative flex items-start mb-6">
            ...
            <div class="ml-12">
                ...
                <p class="text-sm text-gray-600">Peserta mengisi data diri melalui formulir online yang disediakan.</p>
            </div>
        </div>
        ...
        <div class="relative flex items-start mb-6">
            ...
            <div class="ml-12">
                ...
                <p class="text-sm text-gray-600">Setelah mendaftar, peserta akan menerima email konfirmasi berupa file PDF.</p>
            </div>
        </div>
        ...
        <div class="relative flex items-start">
            <div
                ...
                3</div>
            <div class="ml-12">
                <h3 class="text-sm font-bold text-gray-600">Menunggu Informasi Jadwal Masuk</h3>
                <p class="text-sm text-gray-600">Peserta akan dihubungi oleh pihak pengelola terkait jadwal mulai kegiatan ngaji.</p>
            </div>
        </div>
    </div>
</div>
